                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-white p-6 rounded-xl shadow-lg">
                            <p className="text-gray-700 leading-relaxed mb-6">
                                <span className="text-2xl font-semibold text-yellow-600 block mb-4">
                                    Hi there! 👋
                                </span>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {['Python', 'JavaScript', 'React', 'Django', 'Java', 'C++', 'MySQL', 'Machine Learning'].map((skill, index) => (
                            <div 
                                key={index}
                                className="bg-gray-50 px-4 py-2 rounded-lg text-center text-gray-700 text-sm font-medium hover:bg-yellow-50 hover:text-yellow-700 transition-colors duration-300"
                            >
                                {skill}
                            </div>
                        ))}
