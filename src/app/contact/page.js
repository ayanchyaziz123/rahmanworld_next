...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gradient-to-b from-white to-gray-50">
      <div className="bg-white shadow-lg rounded-xl w-full max-w-md border-l-4 border-yellow-500 p-8">
        <h1 className="text-3xl font-bold text-center mb-6">
          <span className="bg-gradient-to-r from-yellow-600 to-yellow-800 bg-clip-text text-transparent">
            Contact Me
          </span>
        </h1>
        <div className="w-24 h-1 bg-gradient-to-r from-yellow-500 to-yellow-600 mx-auto rounded-full mb-8"></div>

        {/* Email Section */}
        <div className="mb-6 bg-yellow-50 p-4 rounded-lg">
          <h2 className="text-xl font-semibold mb-2 text-yellow-800 flex items-center">
        ...
        <div className="bg-yellow-50 p-4 rounded-lg">
          <h2 className="text-xl font-semibold mb-4 text-yellow-800 text-center">
            Find Me On
          </h2>
