                    ...
                    <div className="w-full lg:w-1/2 space-y-8">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed">
                                ...
                                <Link href="#education"  className="text-blue-600 hover:text-blue-800 underline"> educational background</Link> and 
                                <Link href="#experience"  className="text-blue-600 hover:text-blue-800 underline"> professional experience</Link>.
                            </p>
